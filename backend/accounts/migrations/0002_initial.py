...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='userpreference',
            name='lifestyle',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.lifestylekeyword'),
        ),
        migrations.AddField(
            model_name='userpreference',
            name='preferred_reading_style',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.readingstyle'),
        ),
        migrations.AddField(
            model_name='userpreference',
            name='user',
